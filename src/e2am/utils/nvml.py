...
class NVML:
    ...
    def handles(self, indices: Optional[List[int]] = None) -> List[NVMLHandle]:
    ...
    def device_name(self, handle: NVMLHandle) -> Optional[str]:
    ...
    def power_usage_w(self, handle: NVMLHandle) -> Optional[float]:
    ...
    def power_limit_w(self, handle: NVMLHandle) -> Optional[float]:
    ...
    def utilization(self, handle: NVMLHandle) -> Optional[Tuple[float, float]]:
    ...
    def memory_info(self, handle: NVMLHandle) -> Optional[Tuple[float, float]]:
    ...
    def temperature_c(self, handle: NVMLHandle) -> Optional[float]:
